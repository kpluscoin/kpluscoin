Contributing to KPLUS Core
==================================

The KPLUS Core project operates an open contributor model where anyone is
...
The following applies to code changes to the KPLUS Core project, and is not to be
confused with overall KPLUS Network Protocol consensus changes.

Whether a pull request is merged into KPLUS Core rests with the project merge
...
Patches that change KPLUS consensus rules are considerably more involved than
...
Where a patch set proposes to change the KPLUS consensus, it must have been
...
The project leader is the release manager for each KPLUS Core release.
