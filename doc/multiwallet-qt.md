...
In order to support loading of multiple wallets in kplus-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is kplus.cpp.
...
Changes to kplus.cpp
----------------------
kplus.cpp is the entry point into kplus-qt, and as such, will require some minor modifications to provide hooks for
