...
Intro
-----
KPLUS (KPC) is a sustainable cryptocurrency modeled after 
...
high-powered mining hardware. KPLUS utilizes an energy efficient proof-of-stake algorithm, 
...
Setup
-----
Unpack the files into a directory and run kplus-qt.exe.

KPLUS Core is the original KPLUS client and it builds the backbone of the network.
However, it downloads and stores the entire history of KPLUS transactions;
