...
This mechanism has been integrated into Bitcore-Node-KPCcoin which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/kplus/insight-api-kplus#web-socket-api](https://github.com/kplus/insight-api-kplus#web-socket-api)
* API: [https://github.com/kplus/insight-api-kplus#swifttx-transactions](https://github.com/kplus/insight-api-kplus#swifttx-transactions)
...
By default, the KPLUS Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the KPLUS Core daemon:
