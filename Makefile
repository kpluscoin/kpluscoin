...
pkgdatadir = $(datadir)/kplus
pkgincludedir = $(includedir)/kplus
pkglibdir = $(libdir)/kplus
pkglibexecdir = $(libexecdir)/kplus
...
CONFIG_HEADER = $(top_builddir)/src/config/kplus-config.h
...
am__DIST_COMMON = $(srcdir)/Makefile.in \
	...
	$(top_srcdir)/src/config/kplus-config.h.in \
...
ACLOCAL = ${SHELL} /home/kplus-core/build-aux/missing aclocal-1.15
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = /usr/bin/ar
AUTOCONF = ${SHELL} /home/kplus-core/build-aux/missing autoconf
AUTOHEADER = ${SHELL} /home/kplus-core/build-aux/missing autoheader
AUTOMAKE = ${SHELL} /home/kplus-core/build-aux/missing automake-1.15
AWK = gawk
BDB_CPPFLAGS = 
BDB_LIBS = -ldb_cxx-4.8
BITCOIN_CLI_NAME = kplus-cli
BITCOIN_DAEMON_NAME = kplusd
BITCOIN_GUI_NAME = kplus-qt
BITCOIN_TX_NAME = kplus-tx
...
MAINT = 
MAKEINFO = ${SHELL} /home/kplus-core/build-aux/missing makeinfo
MAKENSIS = 
MANIFEST_TOOL = :
MINIUPNPC_CPPFLAGS = 
...
PACKAGE_NAME = KPLUS Core
PACKAGE_STRING = KPLUS Core 2.0.0
PACKAGE_TARNAME = kplus
PACKAGE_URL = 
...
ZMQ_CFLAGS = 
ZMQ_LIBS = -lzmq
abs_builddir = /home/kplus-core
abs_srcdir = /home/kplus-core
abs_top_builddir = /home/kplus-core
abs_top_srcdir = /home/kplus-core
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /home/kplus-core/build-aux/install-sh
...
COVERAGE_INFO = baseline_filtered_combined.info baseline.info block_test.info \
  leveldb_baseline.info test_kplus_filtered.info total_coverage.info \
  baseline_filtered.info block_test_filtered.info \
  leveldb_baseline_filtered.info test_kplus_coverage.info test_kplus.info

OSX_APP_BUILT = $(OSX_APP)/Contents/PkgInfo $(OSX_APP)/Contents/Resources/empty.lproj \
  $(OSX_APP)/Contents/Resources/bitcoin.icns $(OSX_APP)/Contents/Info.plist \
  $(OSX_APP)/Contents/MacOS/KPCcoin-Qt $(OSX_APP)/Contents/Resources/Base.lproj/InfoPlist.strings
...
src/config/kplus-config.h: src/config/stamp-h1
	@test -f $@ || rm -f src/config/stamp-h1
	@test -f $@ || $(MAKE) $(AM_MAKEFLAGS) src/config/stamp-h1

src/config/stamp-h1: $(top_srcdir)/src/config/kplus-config.h.in $(top_builddir)/config.status
	@rm -f src/config/stamp-h1
	cd $(top_builddir) && $(SHELL) ./config.status src/config/kplus-config.h
$(top_srcdir)/src/config/kplus-config.h.in:  $(am__configure_deps) 
	($(am__cd) $(top_srcdir) && $(AUTOHEADER))
	rm -f src/config/stamp-h1
	touch $@

distclean-hdr:
	-rm -f src/config/kplus-config.h src/config/stamp-h1
...
$(OSX_APP)/Contents/MacOS/KPCcoin-Qt: $(BITCOIN_QT_BIN)
	$(MKDIR_P) $(@D)
...
$(APP_DIST_EXTRAS): $(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/KPCcoin-Qt
...
$(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/KPCcoin-Qt: $(OSX_APP_BUILT) $(OSX_PACKAGING)
...
#test_kplus.info: baseline_filtered_combined.info
#	$(MAKE) -C src/ check
#	$(LCOV) -c -d $(abs_builddir)/src -t test_kplus -o $@
#	$(LCOV) -z -d $(abs_builddir)/src
#	$(LCOV) -z -d $(abs_builddir)/src/leveldb

#test_kplus_filtered.info: test_kplus.info
#	$(LCOV) -r $< "/usr/include/*" -o $@

#block_test.info: test_kplus_filtered.info
#	$(MKDIR_P) qa/tmp
...
#test_kplus_coverage.info: baseline_filtered_combined.info test_kplus_filtered.info
#	$(LCOV) -a baseline_filtered.info -a leveldb_baseline_filtered.info -a test_kplus_filtered.info -o $@

#total_coverage.info:  baseline_filtered_combined.info test_kplus_filtered.info block_test_filtered.info
#	$(LCOV) -a baseline_filtered.info -a leveldb_baseline_filtered.info -a test_kplus_filtered.info -a block_test_filtered.info -o $@ | $(GREP) "\%" | $(AWK) '{ print substr($$3,2,50) "/" $$5 }' > coverage_percent.txt

#test_kplus.coverage/.dirstamp:  test_kplus_coverage.info
#	$(GENHTML) -s $< -o $(@D)
#	@touch $@
...
#cov: test_kplus.coverage/.dirstamp total.coverage/.dirstamp

.INTERMEDIATE: $(COVERAGE_INFO)

clean-local:
	rm -rf test_kplus.coverage/ total.coverage/ $(OSX_APP)
