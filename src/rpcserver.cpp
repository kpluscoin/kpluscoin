...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* KPLUS features */
        {"KPLUS", "masternode", &masternode, true, true, false},
        {"KPLUS", "listmasternodes", &listmasternodes, true, true, false},
        {"KPLUS", "getmasternodecount", &getmasternodecount, true, true, false},
        {"KPLUS", "masternodeconnect", &masternodeconnect, true, true, false},
        {"KPLUS", "masternodecurrent", &masternodecurrent, true, true, false},
        {"KPLUS", "masternodedebug", &masternodedebug, true, true, false},
        {"KPLUS", "startmasternode", &startmasternode, true, true, false},
        {"KPLUS", "createmasternodekey", &createmasternodekey, true, true, false},
        {"KPLUS", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"KPLUS", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"KPLUS", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"KPLUS", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"KPLUS", "getmasternodescores", &getmasternodescores, true, true, false},
        {"KPLUS", "mnbudget", &mnbudget, true, true, false},
        {"KPLUS", "preparebudget", &preparebudget, true, true, false},
        {"KPLUS", "submitbudget", &submitbudget, true, true, false},
        {"KPLUS", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"KPLUS", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"KPLUS", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"KPLUS", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"KPLUS", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"KPLUS", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"KPLUS", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"KPLUS", "checkbudgets", &checkbudgets, true, true, false},
        {"KPLUS", "mnsync", &mnsync, true, true, false},
        {"KPLUS", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
...
{
    return "> KPLUS-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:34230/\n";
}
