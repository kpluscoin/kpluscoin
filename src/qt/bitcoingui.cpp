                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("KPLUS Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and kplus: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About KPLUS Core"), this);
    aboutAction->setStatusTip(tr("Show information about KPLUS Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for KPLUS"));
    ...
    openAction->setStatusTip(tr("Open a kplus: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the KPLUS Core help message to get a list with possible KPLUS command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("KPLUS Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to KPLUS network", "", count));
}
...
{
    QString strTitle = tr("KPLUS Core"); // default title
