...
// Copyright (c) 2017 The KPLUS developers
...
static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
	1553078748, // * UNIX timestamp of last checkpoint block
...
public:
    CMainParams()
    {
        ...
        nMinerThreads = 0;
        nTargetTimespan = 2 * 60; // KPLUS: 
        nTargetSpacing = 1 * 60;  // KPLUS:  
        nMaturity = 50;
		...
		const char* pszTimestamp = "THIS WORLD IS DARKNESS , CRYPTO IS START 20 MARCH 2019";
        ...
        genesis.nVersion = 1;
		genesis.nTime = 1553078748;
        genesis.nBits = 0x1e0ffff0;
        genesis.nNonce = 627947;

         
		 
		hashGenesisBlock = genesis.GetHash();
		assert(hashGenesisBlock == uint256("0x00000697f8ffe63be397fffd6c08d149b2d37b25469bea69c0d2136e85dd691a"));
		assert(genesis.hashMerkleRoot == uint256("0xc53f449a62e585bfe95be1929ed91c33cfd93db21ba054b851b72f9b250c067b"));
        ...
        // KPLUS BIP32 pubkeys start with 'xpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x88)(0xB2)(0x1E).convert_to_container<std::vector<unsigned char> >();
        // KPLUS BIP32 prvkeys start with 'xprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x88)(0xAD)(0xE4).convert_to_container<std::vector<unsigned char> >();
        // KPLUS BIP44 coin type is '222' (0x800000de)
        ...
        strSporkKey = "0423f2c48d99f15a0baeedbe9b05b06d028aca587c3a0f0ee4a7dff6b0859181c1025b5842a17e8bb74758b8f1750a82025631f3276bec0734c6f61de81c1e4d28";
        strMasternodePoolDummyAddress = "KAKzgFX8EZt3fwzkPv55Q3sZJauPNdR8DQ";
...
public:
    CTestNetParams()
    {
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // KPLUS: 1 day
        nTargetSpacing = 2 * 60;  // KPLUS: 1 minute
        nLastPOWBlock = 200;
        nMaturity = 15;
      ...
      //  vSeeds.push_back(CDNSSeedData("159.89.119.230", "159.89.119.230"));
        ...
        // Testnet KPLUS addresses start with 'g'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 98);
        // Testnet KPLUS script addresses start with '5' or '6'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 12);
        // Testnet private keys start with 'k'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 108);
        // Testnet KPLUS BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x35)(0x87)(0xCF).convert_to_container<std::vector<unsigned char> >();
        // Testnet KPLUS BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
...
public:
    CRegTestParams()
    {
        ...
        nToCheckBlockUpgradeMajority = 1000;
        nMinerThreads = 1;
        nTargetTimespan = 24 * 60 * 60; // KPLUS: 1 day
        nTargetSpacing = 2 * 60;        // KPLUS: 1 minutes
        bnProofOfWorkLimit = ~uint256(0) >> 1;
        genesis.nTime = 1516926684;
