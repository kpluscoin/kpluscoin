...
#if defined(NDEBUG)
#error "KPLUS cannot be compiled without assertions."
#endif
...
int64_t GetBlockValue(int nHeight)
{
	...
	else if (nHeight > 1001 && nHeight <= 5000000000)
		nSubsidy = 25 * COIN;
	else if (nHeight > 5000000001 && nHeight <= 6000000000)
		nSubsidy = 24 * COIN;
	else if (nHeight > 6000000001 && nHeight <= 7000000000)
		nSubsidy = 23 * COIN;
	else if (nHeight > 7000000001 && nHeight <= 8000000000)
		nSubsidy = 22 * COIN;
	else if (nHeight > 8000000001 && nHeight <= 9000000000)
		nSubsidy = 21 * COIN;
	else if (nHeight > 9000000001 && nHeight <= 10000000000)
		nSubsidy = 20 * COIN;
	else
		nSubsidy = 1 * COIN;
...
bool static ProcessMessage(CNode* pfrom, string strCommand, CDataStream& vRecv, int64_t nTimeReceived)
{
    ...
    if (strCommand == "version") {
        ...
        // KPC: We use certain sporks during IBD, so check to see if they are
