/* src/config/kplus-config.h.  Generated from kplus-config.h.in by configure.  */
/* src/config/kplus-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_NAME "KPLUS Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "KPLUS Core 2.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "kplus"
