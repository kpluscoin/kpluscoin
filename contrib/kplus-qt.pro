...
RESOURCES += src/qt/kplus.qrc src/qt/kplus_locale.qrc

TRANSLATIONS += src/qt/locale/kplus_bg.ts \
                src/qt/locale/kplus_de.ts \
                src/qt/locale/kplus_en.ts \
                src/qt/locale/kplus_es.ts \
                src/qt/locale/kplus_fi.ts \
                src/qt/locale/kplus_fr.ts \
                src/qt/locale/kplus_it.ts \
                src/qt/locale/kplus_ja.ts \
                src/qt/locale/kplus_pl.ts \
                src/qt/locale/kplus_pt.ts \
                src/qt/locale/kplus_ru.ts \
                src/qt/locale/kplus_sk.ts \
                src/qt/locale/kplus_sv.ts \
                src/qt/locale/kplus_vi.ts \
                src/qt/locale/kplus_zh_CN.ts \
                src/qt/locale/kplus_zh_TW.ts
